...
class Level2AdolescentQuestionnaireScreen extends StatefulWidget {
  ...
  @override
  State<Level2AdolescentQuestionnaireScreen> createState() =>
      _Level2AdolescentQuestionnaireScreenState();
}

class _Level2AdolescentQuestionnaireScreenState
    extends State<Level2AdolescentQuestionnaireScreen> {
    ...
    if (_questions.isEmpty) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Text(
              "Error: No Adolescent Level 2 questions found for ${widget.domainScore.domainName}.",
            ),
          ),
        );
      });
  ...
  Widget build(BuildContext context) {
    if (_questions.isEmpty) {
      return Scaffold(
        ...
        body: const Center(
          child: Text("Child Level 2 Questionnaire not available."),
        ),
      );
    }
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text(
              'Based on your previous answers, please answer how much you have been bothered by these problems in the past 7 days.',
