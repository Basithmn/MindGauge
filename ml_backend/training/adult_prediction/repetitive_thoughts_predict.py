...
# --- 1. Model Loading ---
MODEL_PATH = '../../models/adult_model/repetitive_thoughts_lgbm_model.pkl'
ENCODER_PATH = '../../models/adult_model/repetitive_thoughts_label_encoder.pkl'
...
def predict_repetitive_thoughts_severity(raw_scores):
    """
    Accepts 5 raw FOCI scores and calculates the required 7 features.
