...
def predict_mania_severity(raw_scores):
    ...
    """
    if len(raw_scores) != 5:
        raise ValueError("Input must contain exactly 5 scores for the Mania (ASRM) scale.")
...
if __name__ == '__main__':
    # Test cases using direct scores (ASRM range is typically 0-4 per item)
    scores_1 = [5, 5, 4, 5, 5] 
    scores_2 = [1, 2, 1, 1, 2]
    
    print("-" * 50)
    print("CHILDREN MANIA (ASRM) PREDICTOR")
    print("-" * 50)
